...
export const fetchCases = createAsyncThunk("cases/fetchCases",async ({page,sort,caseNumber,division,status}) => {
 
 
  return apiRequest
    .get(`/customer_case_api/get_case?page=${page}&sort=${sort}&case_number=${caseNumber}&division=${division}&status=${status}`, {
      headers: {
