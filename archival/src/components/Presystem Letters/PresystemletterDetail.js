...
function PresystemletterDetail() {
  ...
  return (
    ...
    {loading ? <Loading addtionalStyle={"flex justify-center items-center my-[20px]"}/>:   <div className="w-[90%] my-[50px] mx-auto max-lg2:my-[30px]">
     <div className="flex justify-between items-center  gap-[5px]">
       ...
       <button onClick={()=>navigate(`/letters/archive/presystem/${id}`)}  className="py-2 px-4 text-[12px] text-white bg-[#0C73B8] rounded-[20px] font-bold max-lg2:text-[10px]">
             {translationState?.lan==="En" && language?.archiveLetter[0]}
             {translationState?.lan==="Am" && language?.archiveLetter[1]}
             </button>
           
           <div className="flex gap-[10px]">
          <button onClick={()=>navigate(`/forward/presystem/${presystemLetter?._id}`)} className="py-2 px-4 text-[12px] text-white bg-[#0C73B8] rounded-[20px] font-bold max-lg2:text-[10px]">
             {translationState?.lan==="En" && language?.forward[0]}
             {translationState?.lan==="Am" && language?.forward[1]}
             </button>
            
           <button onClick={()=>navigate(`/forwarded_path/presystem/${presystemLetter?._id}`)} className="py-2 px-4 text-[12px] text-white bg-[#0C73B8] rounded-[20px] font-bold max-lg2:text-[10px]">
             {translationState?.lan==="En" && language?.forwardPath[0]}
             {translationState?.lan==="Am" && language?.forwardPath[1]}
             </button>

             {presystemLetter?.status ==="created" &&     <button onClick={()=>navigate(`/letters/presystem/edit/${presystemLetter?._id}`)} className="py-2 px-4 text-[12px] text-white bg-[#0C73B8] rounded-[20px] font-bold max-lg2:text-[10px]">
...
export default PresystemletterDetail