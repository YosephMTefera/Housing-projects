  ...
  return (
    ...
    <div className="w-[80%] mx-auto p-2 min-h-[250px] bg-white rounded-[10px] max-lg2:w-[90%]">
      <div className="w-[90%] my-[20px] flex items-center justify-start text-[#FBB042] mx-auto font-bold">
        ...
        {translationState?.lan ==="En" && language?.ethicsUserInformation[0]}
        {translationState?.lan ==="Am" && language?.ethicsUserInformation[1]}
        </span>
      </div>
        ...
        <div className="w-[80%]  flex flex-col gap-[20px]">
          ...
          <div className="w-[80%] my-[30px] mx-auto flex justify-between items-start gap-[50px] max-lg2:w-[100%]">
            ...
            <span className="text-gray-500 flex items-center gap-[10px]">
                ...
                {translationState?.lan ==="En" && ethicsUser?.gender}
                {translationState?.lan ==="Am" && ethicsUser?.gender ==="Male" ? language?.male[1]:language?.female[1]}
                  </span>
              </span>
              ...
              <span className="text-gray-500 flex items-center gap-[10px]">
                ...
                <span className="max-lg2:text-[12px]">{ethicsUser?.createdBy?.firstname} {ethicsUser?.createdBy?.middlename} {ethicsUser?.createdBy?.lastname}</span>
              </span>
