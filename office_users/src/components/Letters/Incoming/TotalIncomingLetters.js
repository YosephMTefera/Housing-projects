    ...
    <div className="flex pb-4 justify-start items-center border-b">
      <IoChevronBack
        ...
        <span className="text-[#0C73B8] font-bold text-[20px] max-lg2:text-[16px]">        
          {translationState?.lan==="En" && `${language?.totalIncomingLetters[0]}`}
        {translationState?.lan==="Am" && `${language?.totalIncomingLetters[1]}`}</span>
            ...
            <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                font-semibold  bg-gray-300 text-black rounded-[5px]"
                          >
                          {translationState?.lan==="En" && language?.createdInc[0]}
                          {translationState?.lan==="Am" && language?.createdInc[1]} 
                          </span>}
                ...
                font-semibold  bg-green-600 text-white rounded-[5px]"
                          >
                        {translationState?.lan==="En" && language?.forwardedInc[0]}
                        {translationState?.lan==="Am" && language?.forwardedInc[1]} 
                          </span>
                    }
...
export default TotalIncomingLetters