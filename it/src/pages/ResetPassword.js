  ...
  const handleResetPassword = async ()=>{
    try {
      ...
      if(password !==confirmPassword){
        ...
        await apiRequest.put(`/it_user_api/reset_it_user/${id}/${token}`,{password},{headers:{
          get_itusers_reset_api: process.env.REACT_APP_GET_ITUSERS_RESET_API,
        }}).then((res)=>{
          setLoading(false)
  ...
  <div className="w-[30%] mt-[100px] shadow-md rounded-[10px] bg-white z-[10] p-4 flex flex-col items-center gap-[30px] max-lg2:mt-[50px] max-lg2:w-[50%] max-lg1:w-[70%] max-sm1:w-[90%]">
    ...
    <div className="w-[80%] mx-auto flex flex-col gap-[20px]">
      ...
      />
        ...
        <div className='flex flex-col gap-[10px]'>
        <span className="text-[14px] font-bold text-[#0C73B8]">Re-Type Password</span>
        <input
        type="password"
